...
class GetCharacterByHouseResponseModel {
  String? id;
  String? name;
  ...
  GetCharacterByHouseResponseModel({
    this.id,
    this.name,
    this.alternateNames,
    this.species,
  ...
  factory GetCharacterByHouseResponseModel.fromJson(String str) =>
      GetCharacterByHouseResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory GetCharacterByHouseResponseModel.fromMap(Map<String, dynamic> json) =>
      GetCharacterByHouseResponseModel(
        id: json["id"],
        name: json["name"],
